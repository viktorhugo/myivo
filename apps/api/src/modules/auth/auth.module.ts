  ...
  providers: [
    {
      ...
      useFactory: (prisma: PrismaService, configService: ConfigService<Env, true>) =>
        crearAuth(prisma, {
          ...
          GOOGLE_CLIENT_ID: configService.get('GOOGLE_CLIENT_ID', { infer: true }),
          GOOGLE_CLIENT_SECRET: configService.get('GOOGLE_CLIENT_SECRET', { infer: true }),
          MICROSOFT_CLIENT_ID: configService.get('MICROSOFT_CLIENT_ID', { infer: true }),
          MICROSOFT_CLIENT_SECRET: configService.get('MICROSOFT_CLIENT_SECRET', { infer: true }),
          GITHUB_CLIENT_ID: configService.get('GITHUB_CLIENT_ID', { infer: true }),
          GITHUB_CLIENT_SECRET: configService.get('GITHUB_CLIENT_SECRET', { infer: true }),
        }),
